(function() {
  ...
  pagseguro = (function() {
    ...
    pagseguro.prototyreceiverEmailpe.receiverEmail = function (email) {
      this.obj.receiver = {};
    ...
    pagseguro.prototype.send = function(callback) {
      ...
      return req(options, function(err, res, body) {
        if (err) {
          ...
          return callback(null, xmlParse.toJson(body));
        }
      });
    };
    ...
    pagseguro.prototype.statusByCode = function(code) {
      ...
      state = status.filter(function(state) {
